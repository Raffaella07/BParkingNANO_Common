...
public :
   ...
   */
   ...
   TTreeReaderArray<Bool_t> Muon_isGlobalMuon = {fReader, "Muon_isGlobalMuon"};
   TTreeReaderArray<Bool_t> Muon_isGlobalNotTrackerMuon = {fReader, "Muon_isGlobalNotTrackerMuon"};
   TTreeReaderArray<Bool_t> Muon_isGlobalOrTrackerMuon = {fReader, "Muon_isGlobalOrTrackerMuon"};
   TTreeReaderArray<Bool_t> Muon_isPF = {fReader, "Muon_isPF"};
   TTreeReaderArray<Bool_t> Muon_isTrackerMuon = {fReader, "Muon_isTrackerMuon"};
   TTreeReaderArray<Bool_t> Muon_isTrackerNotGlobalMuon = {fReader, "Muon_isTrackerNotGlobalMuon"};
   TTreeReaderArray<Bool_t> Muon_mediumId = {fReader, "Muon_mediumId"};
   TTreeReaderArray<UChar_t> Muon_pfIsoId = {fReader, "Muon_pfIsoId"};
   TTreeReaderArray<Bool_t> Muon_softId = {fReader, "Muon_softId"};
   TTreeReaderArray<Bool_t> Muon_tightId = {fReader, "Muon_tightId"};
   ...
   Float_t the_sig_hnl_iso03_rel_close;
   Float_t the_sig_hnl_iso04;
   Float_t the_sig_hnl_iso04_close;
   Float_t the_sig_hnl_iso04_rel_close;
   ...
   Float_t the_sig_trgmu_iso03_rel_close;
   Float_t the_sig_trgmu_pfiso04;
   Float_t the_sig_trgmu_pfiso04_rel;
   Float_t the_sig_trgmu_iso04;
   Float_t the_sig_trgmu_iso04_close;
   Float_t the_sig_trgmu_iso04_rel_close;
   Int_t the_sig_trgmu_looseid;
   Int_t the_sig_trgmu_mediumid;
   Int_t the_sig_trgmu_tightid;
   Int_t the_sig_trgmu_softid;
   Int_t the_sig_trgmu_pfisoid;
   Int_t the_sig_trgmu_trkisoid;
   Int_t the_sig_trgmu_triggerlooseid;
   Int_t the_sig_trgmu_istriggering;
   Int_t the_sig_trgmu_isPF;
   Int_t the_sig_trgmu_isglobalmuon;
   Int_t the_sig_trgmu_istrackermuon;
   Int_t the_sig_trgmu_isglobalortrackermuon;
   Int_t the_sig_trgmu_isglobalnottrackermuon;
   Int_t the_sig_trgmu_istrackernotglobalmuon;
   Int_t the_sig_trgmu_intimemuon;
   Float_t the_sig_trgmu_segmentcompatibility;
   Float_t the_sig_trgmu_calocompatibility;
   Float_t the_sig_trgmu_validhitfraction;
   Float_t the_sig_trgmu_kinkfinderchi2;
   Float_t the_sig_trgmu_globalnormalisedchi2;
   Float_t the_sig_trgmu_localpositionchi2;
   Int_t the_sig_trgmu_trackerhighpurityflag;
   Int_t the_sig_trgmu_numberofvalidmuonhits;
   Int_t the_sig_trgmu_numberofvalidpixelhits;
   Int_t the_sig_trgmu_numberoftrackerlayers;
   Int_t the_sig_trgmu_numberofpixellayers;
   Int_t the_sig_trgmu_numberofstations;
   Int_t the_sig_trgmu_fired_HLT_Mu7_IP4;
   Int_t the_sig_trgmu_fired_HLT_Mu8_IP6;
   Int_t the_sig_trgmu_fired_HLT_Mu8_IP5;
   Int_t the_sig_trgmu_fired_HLT_Mu8_IP3;
   Int_t the_sig_trgmu_fired_HLT_Mu8p5_IP3p5;
   Int_t the_sig_trgmu_fired_HLT_Mu9_IP6;
   Int_t the_sig_trgmu_fired_HLT_Mu9_IP5;
   Int_t the_sig_trgmu_fired_HLT_Mu9_IP4;
   Int_t the_sig_trgmu_fired_HLT_Mu10p5_IP3p5;
   Int_t the_sig_trgmu_fired_HLT_Mu12_IP6;
   ...
   Float_t the_sig_mu_iso03_rel_close;
   Float_t the_sig_mu_pfiso04;
   Float_t the_sig_mu_pfiso04_rel;
   Float_t the_sig_mu_iso04;
   Float_t the_sig_mu_iso04_close;
   Float_t the_sig_mu_iso04_rel_close;
   Int_t the_sig_mu_looseid;
   Int_t the_sig_mu_mediumid;
   Int_t the_sig_mu_tightid;
   Int_t the_sig_mu_softid;
   Int_t the_sig_mu_pfisoid;
   ...
   Int_t the_sig_mu_isglobalortrackermuon;
   Int_t the_sig_mu_isglobalnottrackermuon;
   Int_t the_sig_mu_istrackernotglobalmuon;
   Int_t the_sig_mu_intimemuon;
   Float_t the_sig_mu_segmentcompatibility;
   Float_t the_sig_mu_calocompatibility;
   Float_t the_sig_mu_validhitfraction;
   Float_t the_sig_mu_kinkfinderchi2;
   Float_t the_sig_mu_globalnormalisedchi2;
   Float_t the_sig_mu_localpositionchi2;
   Int_t the_sig_mu_trackerhighpurityflag;
   Int_t the_sig_mu_numberofvalidmuonhits;
   Int_t the_sig_mu_numberofvalidpixelhits;
   Int_t the_sig_mu_numberoftrackerlayers;
   Int_t the_sig_mu_numberofpixellayers;
   Int_t the_sig_mu_numberofstations;
   ...
   Float_t the_sig_pi_iso03_rel_close;
   Float_t the_sig_pi_iso04;
   Float_t the_sig_pi_iso04_close;
   Float_t the_sig_pi_iso04_rel_close;

   Float_t the_sig_trgmu_mu_mass;
   Float_t the_sig_trgmu_mu_pt;
   Float_t the_sig_trgmu_pi_mass;
   Float_t the_sig_trgmu_pi_pt;
   ...
   Float_t the_sig_deltar_trgmu_mu;
   Float_t the_sig_deltar_trgmu_pi;
   Float_t the_sig_deltaeta_mu_pi;
   Float_t the_sig_deltaeta_trgmu_hnl;
   Float_t the_sig_deltaeta_trgmu_mu;
   Float_t the_sig_deltaeta_trgmu_pi;
   Float_t the_sig_deltaphi_mu_pi;
   Float_t the_sig_deltaphi_trgmu_hnl;
   Float_t the_sig_deltaphi_trgmu_mu;
   Float_t the_sig_deltaphi_trgmu_pi;
   Float_t the_sig_deltapt_pi_fit_pi;
   Float_t the_sig_deltapt_mu_fit_mu;
   Float_t the_sig_deltaeta_pi_fit_pi;
   Float_t the_sig_deltaeta_mu_fit_mu;
   Float_t the_sig_deltaphi_pi_fit_pi;
   Float_t the_sig_deltaphi_mu_fit_mu;
