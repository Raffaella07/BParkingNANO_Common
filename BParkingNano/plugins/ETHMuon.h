  ...
  class ETHMuon : public PATObject<reco::CompositeCandidate>{
    public:
      ...
      ETHMuon(const reco::Track& muon)
      {
        ...
        vy_ = muon.vy();
        vz_ = muon.vz();
        dz_ = 99.; // needs to be studied, see https://cmssdt.cern.ch/lxr/source/DataFormats/TrackReco/interface/TrackBase.h
        dzS_ = 99.; // needs to be studied, see https://cmssdt.cern.ch/lxr/source/DataFormats/TrackReco/interface/TrackBase.h
        dxy_ = 99.; // needs to be studied, see https://cmssdt.cern.ch/lxr/source/DataFormats/TrackReco/interface/TrackBase.h
        dxyS_ = 99.; // needs to be studied, see https://cmssdt.cern.ch/lxr/source/DataFormats/TrackReco/interface/TrackBase.h
        ip3d_ = 99; // to modify
        sip3d_ = 99; // to modify
