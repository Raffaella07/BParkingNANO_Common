...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    # data
    #InputFileNames = cms.vstring("/pnfs/psi.ch/cms/trivcat/store/user/anlyon/BHNLsGen/data/V06_tag_and_probe/ParkingBPH1_Run2018A/merged/flat_bparknano_tag_and_probe_v1.root"),

    InputTreeName = cms.string("tree"),
    # output
    OutputFileName = cms.string("results_tag_and_probe_v2_tag_fired_DST_DoubleMu1_mc.root"),
    ...
    Efficiencies = cms.PSet(
        ...
        cat_pt_eta = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                probe_pt = cms.vdouble(6.0, 8.0, 9.0, 10.0, 12.0, 100.0),
                probe_eta = cms.vdouble(0.0, 0.5, 1.0, 2.0),
            ),
        ...
        #    UnbinnedVariables = cms.vstring("mass"),
        #    BinnedVariables = cms.PSet(
        #        probe_pt = cms.vdouble(6.0, 8.0, 9.0, 10.0, 12.0, 15.0),
        #        probe_eta = cms.vdouble(0.0, 0.5, 1.0, 2.0),
        #    ),
        #    BinToPDFmap = cms.vstring("gaussPlusLinear")
        #),
